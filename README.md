...
1. And save your API Key shown in the picture below. Please note: before you save the API key, click on the eye 
   to the left of "Show Credentials in the picture to make it visible. 
